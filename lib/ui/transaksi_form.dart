...
import 'package:tiketapp/bloc/transaksi_bloc.dart';
import 'package:tiketapp/model/transaksi.dart';
import 'package:tiketapp/ui/transaksi_page.dart';
import 'package:tiketapp/widget/warning_dialog.dart';
...
class _TransaksiFormState extends State<TransaksiForm> {
  ...
  simpan() {
    ...
    createTransaksi.nominalTransaksi =
        int.parse(_nominalTransaksiTextboxController.text);
  ...
  ubah() {
    ...
    updateTransaksi.nominalTransaksi =
        int.parse(_nominalTransaksiTextboxController.text);
